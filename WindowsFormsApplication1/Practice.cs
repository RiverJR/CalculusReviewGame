...
namespace WindowsFormsApplication1 {
    public partial class Practice :Form {
        ...
        private bool isCorrect() {
            ...
            else if (difficulty == 2) { //TODO: CHECK CHAIN RULE ANSWER
                return true;
            }
        ...
        private void simpleDerivative() {// generates and displays simple derivative
        ...
        private void chainRule() { //generates and displays chain problem
            int exponent = rnd.Next(2,9);
